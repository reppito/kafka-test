 ...
 */
export const createKafkaClient = (config = {}) => {
    const kafkaConfig = {
        ...defaultConfig,
        ...config
    };
 ...
 */
export const createProducer = async (config = {}) => {
 ...
 */
export const createConsumer = async (messageHandler, config = {}) => {
 ...
 */
export const createMessage = (content, type = 'default', metadata, payload) => {
    return {
        id: randomUUID(),
        type,
        content,
 ...
 */
export const sendMessage = async (producer, message, topic) => {
